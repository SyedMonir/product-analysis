    ...
    <section className="text-center my-3">
      ...
      <article>
        ...
        <p>
          ...
          components, for reusability purposes. Context API solves one major
          problem is prop drilling. Prop drilling is getting data from parent
          component to child component. Context give us a way to pass data to
          component without doing props drilling. If you only want to avoid
          passing props through many levels, Context API is best.
        </p>
      </article>
      {/* Qus 2  */}
      <article>
        ...
        <p>
          ...
          semantic elements section , aside , nav , article , header, footer. It
          has best accessibility. Search engines and who has visual problem are
          also able to better understand the content of our website. That means
      ...
      <article>
        <h4>
          <strong>
            Q 1: Difference between inline, block, inline-block elements?
          </strong>
        </h4>
        <p>
