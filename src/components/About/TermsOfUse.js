...
const TermsOfUse = () => {
  return (
    <section>
      ...
      <p>
        Welcome to Games Breakdown! These terms and conditions outline the rules
        and regulations for the use of Games Breakdown's Website, located at
        https://games-breakdown.netlify.app/. By accessing this website we
        assume you accept these terms and conditions. Do not continue to use
        Games Breakdown if you do not agree to take all of the terms and
